...
namespace BeamLab.PeopleDirectory.Controllers
{
    public class AccountController : Controller
    {
        ...
        public void SignIn()
        {
            HttpContext.GetOwinContext().Authentication.Challenge(new AuthenticationProperties { RedirectUri = "/Install/InstallationOk" }, OpenIdConnectAuthenticationDefaults.AuthenticationType);
        }
        ...
        public ActionResult GrantPermissions(string admin_consent, string tenant, string error, string error_description)
        {
            ...
            {
                return new RedirectResult("/Install/InstallationOk");
            }
